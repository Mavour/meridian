...
MIN_TOKEN_FEES_SOL filter is now HARDFILTERED in code during screening — tokens below ${config.screening.minTokenFeesSol} SOL are removed BEFORE the candidate list reaches you.
