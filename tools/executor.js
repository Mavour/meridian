...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      pnlPollAdaptiveEnabled: ["management", "pnlPollAdaptiveEnabled"],
      pnlPollNormalIntervalSec: ["management", "pnlPollNormalIntervalSec"],
      pnlPollFastIntervalSec: ["management", "pnlPollFastIntervalSec"],
      pnlPollUrgentIntervalSec: ["management", "pnlPollUrgentIntervalSec"],
      pnlPollNewPositionMinutes: ["management", "pnlPollNewPositionMinutes"],
      exitSnapshotMaxDiffPct: ["management", "exitSnapshotMaxDiffPct"],
      whaleGuardEnabled: ["whaleGuard", "enabled"],
      whaleGuardSource: ["whaleGuard", "source"],
      whaleGuardWindowMinutes: ["whaleGuard", "windowMinutes"],
      whaleGuardCooldownMinutes: ["whaleGuard", "cooldownMinutes"],
      whaleGuardMinNetWithdrawUsd: ["whaleGuard", "minNetWithdrawUsd"],
      whaleGuardMinQuoteDrainUsd: ["whaleGuard", "minQuoteDrainUsd"],
      whaleGuardMinTvlDropUsd: ["whaleGuard", "minTvlDropUsd"],
      whaleGuardMinLiquidityDropPct: ["whaleGuard", "minTvlDropPct"],
      whaleGuardMinTvlDropPct: ["whaleGuard", "minTvlDropPct"],
      whaleGuardRequireBaseIncreaseForQuoteDrain: ["whaleGuard", "requireBaseIncreaseForQuoteDrain"],
      ...
      bottomSpotMinRetracePct: ["bottomSpotLP", "minRetracePct", ["bottomSpotLP", "minRetracePct"]],
      bottomSpotAthLookbackCandles: ["bottomSpotLP", "athLookbackCandles", ["bottomSpotLP", "athLookbackCandles"]],
      bottomSpotCandleInterval: ["bottomSpotLP", "candleInterval", ["bottomSpotLP", "candleInterval"]],
      bottomSpotRsiExitThreshold: ["bottomSpotLP", "rsiExitThreshold", ["bottomSpotLP", "rsiExitThreshold"]],
      bottomSpotTakeProfitFeePct: ["bottomSpotLP", "takeProfitFeePct", ["bottomSpotLP", "takeProfitFeePct"]],
      bottomSpotMaxILPct: ["bottomSpotLP", "maxILPct", ["bottomSpotLP", "maxILPct"]],
      bottomSpotMinFeesToOverrideStopLoss: ["bottomSpotLP", "minFeesToOverrideStopLoss", ["bottomSpotLP", "minFeesToOverrideStopLoss"]],
      bottomSpotOutOfRangeWaitMinutes: ["bottomSpotLP", "outOfRangeWaitMinutes", ["bottomSpotLP", "outOfRangeWaitMinutes"]],
      bottomSpotOutOfRangeTolerance: ["bottomSpotLP", "outOfRangeTolerance", ["bottomSpotLP", "outOfRangeTolerance"]],
