...
function formatConfigSnapshot() {
  return [
    ...
    `Slow bleed: ${config.management.slowBleedExitEnabled === false ? "off" : "on"} | age >= ${config.management.slowBleedMinAge ?? 20}m | PnL ${config.management.slowBleedMinPnl ?? -1}% to ${config.management.slowBleedMaxPnl ?? 0.5}% | auto-close`,
...
function settingValue(key) {
  ...
  const values = {
    ...
    politicalNyopetEnabled: config.screening.politicalNyopetEnabled,
    downtrendProtectionEnabled: config.screening.downtrendProtectionEnabled,
    ...
    slowBleedExitEnabled: config.management.slowBleedExitEnabled,
...
const SETTINGS_PAGES = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "downtrendProtectionEnabled", label: "Downtrend guard", type: "toggle" },
      ...
      { key: "politicalNyopetEnabled", label: "Political nyopet", type: "toggle" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "slowBleedExitEnabled", label: "Slow bleed exit", type: "toggle" },
