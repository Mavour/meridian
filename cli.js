...
\`\`\`
Valid keys include: minTvl, maxTvl, minVolume, maxPositions, deployAmountSol, managementIntervalMin, screeningIntervalMin, managementModel, screeningModel, generalModel, autoSwapAfterClaim, minClaimAmount, outOfRangeWaitMinutes, whaleGuardEnabled, whaleGuardMinQuoteDrainUsd, whaleGuardMinLiquidityDropPct
\`\`\`
